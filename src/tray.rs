...
use anyhow::Result;
use tray_icon::{
    menu::{Menu, MenuEvent, MenuItem, MenuId, MenuItemBuilder, PredefinedMenuItem},
...
fn open_trident_id() -> MenuId { MenuId::new("open_trident") }
fn start_at_login_id() -> MenuId { MenuId::new("start_at_login") }
fn quit_trident_id() -> MenuId { MenuId::new("quit_trident") }
